...
# Experiment: ode_033 - Running 1 experiment with nohup
# Dimension: 2D
...
echo "========================================="
echo "ode_033 - Running 1 experiment with nohup"
echo "Dimension: 2D"
...
echo "[START] Experiment 1/1: ode_033 - sigma00_desc_de"
nohup $PYTHON_CMD -u main.py \
    ...
    > "$LOG_DIR/ode_033_experiment.log" 2>&1 &
PID1=$!
echo "  PID: $PID1"
...
echo "Log files:"
echo "  - $LOG_DIR/ode_033_experiment.log"
echo "========================================="
echo ""
...
if [ $EXIT1 -eq 0 ]; then
    echo ""
    echo "[ALL EXPERIMENTS COMPLETE] ode_033 - 1 experiment completed successfully!"
    exit 0
else
    echo ""
