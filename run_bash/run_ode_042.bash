...
# Experiment: ode_042 - Running 1 experiment with nohup
# Dimension: 2D
...
echo "========================================="
echo "ode_042 - Running 1 experiment with nohup"
echo "Dimension: 2D"
...
echo "[START] Experiment 1/1: ode_042 - sigma00_desc_de_scientist"
nohup $PYTHON_CMD -u main.py \
    --use_var_desc true \
    --use_scientist true \
    --problem_name ode_042 \
    --use_gt false \
    --max_params 8 \
    --dim 2 \
    --evolution_num 100 \
    ...
    > "$LOG_DIR/ode_042_experiment.log" 2>&1 &
PID1=$!
echo "  PID: $PID1"
...
echo "Log files:"
echo "  - $LOG_DIR/ode_042_experiment.log"
echo "========================================="
echo ""
...
if [ $EXIT1 -eq 0 ]; then
    echo ""
    echo "[ALL EXPERIMENTS COMPLETE] ode_042 - 1 experiment completed successfully!"
    exit 0
else
    echo ""
