...
# Experiment: ode_046 - Running 1 experiment with nohup
# Dimension: 2D
# Experiment configuration:
#   1. sigma00_desc_de (use_gt=false)
...
echo "========================================="
echo "ode_046 - Running 1 experiment with nohup"
echo "Dimension: 2D"
...
echo "[START] Experiment 1/1: ode_046 - sigma00_desc_de"
nohup $PYTHON_CMD -u main.py \
    --use_var_desc true \
    --use_scientist false \
    --problem_name ode_046 \
    --use_gt false \
    --max_params 8 \
    --dim 2 \
    --evolution_num 100 \
    ...
    > "$LOG_DIR/ode_046_experiment.log" 2>&1 &
PID1=$!
echo "  PID: $PID1"
...
echo "Log files:"
echo "  - $LOG_DIR/ode_046_experiment.log"
echo "========================================="
echo ""
...
if [ $EXIT1 -eq 0 ]; then
    echo ""
    echo "[ALL EXPERIMENTS COMPLETE] ode_046 - 1 experiment completed successfully!"
    exit 0
else
    echo ""
